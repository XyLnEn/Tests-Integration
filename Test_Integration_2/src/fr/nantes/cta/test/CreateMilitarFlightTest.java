...
public class CreateMilitarFlightTest {
	...
	public void testCreateMilitarFlight() throws IncompatibleAirway, AirplaneOverload {
		Flight f = new CreateMilitarFlight(_depart, _arrive, _avion1, _flightplan, _nbpassenger);
		assertNotNull(f);
	}
	...
	public void testdetectAirplaneOverload() throws IncompatibleAirway, AirplaneOverload {
		Flight f = new CreateMilitarFlight(_depart, _arrive, _avion2, _flightplan, _nbpassenger);
	}
	...
	public void testdetectIncompatibleAirway() throws IncompatibleAirway, AirplaneOverload {
		Flight f = new CreateMilitarFlight(_depart, _arrive, _avion3, _flightplan, _nbpassenger);
	}
...
//	}
	...
	public void testLoadingWeight() throws IncompatibleAirway, AirplaneOverload {
		Flight f = new CreateMilitarFlight(_depart, _arrive, _avion1, _flightplan, _nbpassenger);
		assertEquals((_nbpassenger*(70+100)), f.loadingWeight(), 0);
	}

	@Test
	public void testTotalWeight() throws IncompatibleAirway, AirplaneOverload {
		Flight f = new CreateMilitarFlight(_depart, _arrive, _avion1, _flightplan, _nbpassenger);
		assertEquals((_nbpassenger*(70+100))+_avion1.weight(), f.totalWeight(), 0);
	}
